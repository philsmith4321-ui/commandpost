...
PUNCTUATION RULE: never use the long dash (em dash or en dash) or "---" anywhere. Use commas, periods, or parentheses instead. Number ranges use a plain hyphen (e.g. "30-60 minutes").
...
Nonprofit: 4x grants
Anything else: a recent client cut a major time-sink ~80%, another tripled bookings.
